...
<div class="container">
  <a href="{base_url()}admin/fornecedor/listar/" class="btn btn-success">Listar Fornecedores</a>
  <form class="form-horizontal" id="createGeneric" method="POST" action="{$action}">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input class="input-xxlarge cnpj" type="text" id="cnpj" name="cnpj" value="{$item->cnpj}" placeholder="Cnpj">
      </div>
    </div>
    <div class="control-group">
